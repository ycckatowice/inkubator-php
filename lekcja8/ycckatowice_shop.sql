...
INSERT INTO `product` (`id`, `name`, `category_id`, `cost`) VALUES
	(1, 'Pralka WHIRLPOOL AWE60110 A+ 6KG', 1, 959),
	(2, 'Samsung Galaxy A5 (2017) LTE 32GB Czarny', 1, 1082.99),
...
-- Zrzucanie danych dla tabeli ycckatowice_shop.user: ~0 rows (około)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `city`) VALUES
	(1, 'Mikołaj', 'Woźniak', 'wmikolaj.pol@gmail.com', 'Katowice'),
	(2, 'Oskar', NULL, 'oskar@gmail.com', 'Bytom');
